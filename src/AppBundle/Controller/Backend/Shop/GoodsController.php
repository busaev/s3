...
class GoodsController extends Controller 
{
     ...
     *
     * @Route("/new", name="backend_shop_goods_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        return $this->render('backend/modules/shop/goods/new.html.twig', array(
     ...
     *
     * @Route("/{id}/edit", name="backend_shop_goods_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, $id)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid())
        {
            ...
            // remove the relationship between the Value and the Goods
            ...
            return $this->redirectToRoute('backend_shop_goods_edit', array('id' => $entity->getId()));
        }

        return $this->render('backend/modules/shop/goods/edit.html.twig', array(
            'entityCode'=>$entityCode,
            'entity' => $entity,
