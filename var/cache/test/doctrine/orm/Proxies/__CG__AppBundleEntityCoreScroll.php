 ...
 */
class Scroll extends \AppBundle\Entity\Core\Scroll implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Core\\Scroll' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Core\\Scroll' . "\0" . 'code', '' . "\0" . 'AppBundle\\Entity\\Core\\Scroll' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Core\\Scroll' . "\0" . 'position', '' . "\0" . 'AppBundle\\Entity\\Core\\Scroll' . "\0" . 'items'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Scroll $proxy) {
