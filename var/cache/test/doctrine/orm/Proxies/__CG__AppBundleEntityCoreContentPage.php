 ...
 */
class ContentPage extends \AppBundle\Entity\Core\ContentPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Core\\ContentPage' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Core\\ContentPage' . "\0" . 'entityCode', '' . "\0" . 'AppBundle\\Entity\\Core\\ContentPage' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Core\\ContentPage' . "\0" . 'action', '' . "\0" . 'AppBundle\\Entity\\Core\\ContentPage' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Core\\ContentPage' . "\0" . 'navigationItems', '' . "\0" . 'AppBundle\\Entity\\Core\\ContentPage' . "\0" . 'contentType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContentPage $proxy) {
