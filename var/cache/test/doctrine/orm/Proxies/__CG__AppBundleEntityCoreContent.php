 ...
 */
class Content extends \AppBundle\Entity\Core\Content implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Core\\Content' . "\0" . 'entityCode', '' . "\0" . 'AppBundle\\Entity\\Core\\Content' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Core\\Content' . "\0" . 'routePath', '' . "\0" . 'AppBundle\\Entity\\Core\\Content' . "\0" . 'entryStatus', '' . "\0" . 'AppBundle\\Entity\\Core\\Content' . "\0" . 'contentPages', '' . "\0" . 'AppBundle\\Entity\\Core\\Content' . "\0" . 'navigationItems'];
        }
    ...
    public function addContentPage(\AppBundle\Entity\Core\ContentPage $contentPage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addContentPage', [$contentPage]);

        return parent::addContentPage($contentPage);
    }
    ...
    public function removeContentPage(\AppBundle\Entity\Core\ContentPage $contentPage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeContentPage', [$contentPage]);

        return parent::removeContentPage($contentPage);
    }
    ...
    public function getContentPages()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContentPages', []);

        return parent::getContentPages();
    }
