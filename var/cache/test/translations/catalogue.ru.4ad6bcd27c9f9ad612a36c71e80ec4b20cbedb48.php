...
$catalogue = new MessageCatalogue('ru', array (
  ...
  array (
    ...
    'Scroll items' => 'Элементы списка',
    'Module Pages' => 'Cраницы модуля',
    'Module page' => 'Страница модуля',
    'Dashboard' => 'Сводка',
    'Shop' => 'Магазин',
    'Title' => 'Название',
    ...
    'Login' => 'Войти',
    'User' => 'Пользователь',
    'User roles' => 'Пользовательские роли',
    ...
    'Route path' => 'Путь',
    'File' => 'Файл',
    'Show in preview' => 'Показать в предпросмотре',
    'Show in filters' => 'Показать в фильтрах',
    'Media' => 'Медиа',
  ...
  'messages' => 
  array (
    'Invalid credentials' => 'Ошибка авторизации',
    'A new entry is added!' => 'Новая запись добавлена!',
    'A new user is added!' => 'Новый пользователь добавлен!',
