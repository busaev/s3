...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'admin.checker' => 'getAdmin_CheckerService',
            ...
            'brend.entity' => 'getBrend_EntityService',
            ...
            'hwi_oauth.resource_owner.mailru' => 'getHwiOauth_ResourceOwner_MailruService',
            'hwi_oauth.resource_ownermap.oauth_public' => 'getHwiOauth_ResourceOwnermap_OauthPublicService',
            ...
            'security.firewall.map.context.oauth_public' => 'getSecurity_Firewall_Map_Context_OauthPublicService',
        ...
        $this->aliases = array(
            ...
            'hwi_oauth.user.provider.entity.oauth_public' => 'hwi_oauth.user.provider.entity',
            'hwi_oauth.user_checker' => 'security.user_checker.secured_area',
            'mailer' => 'swiftmailer.mailer.default',
            'security.user_checker.oauth_public' => 'security.user_checker.secured_area',
    ...
    /**
     * Gets the 'admin.checker' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Provider\AdminChecker A AppBundle\Provider\AdminChecker instance
     */
    protected function getAdmin_CheckerService()
    {
        return $this->services['admin.checker'] = new \AppBundle\Provider\AdminChecker($this->get('doctrine'), array('mailru' => array(0 => '747626')));
    }
    ...
    protected function getApp_EntitiesService()
    {
        ...
        $instance->addEntity('brend', $this->get('brend.entity'));
    ...
    /**
     * Gets the 'app.route' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\Route A AppBundle\Services\Route instance
     */
    protected function getApp_RouteService()
    {
        return $this->services['app.route'] = new \AppBundle\Services\Route($this);
    }
    ...
    /**
     * Gets the 'brend.entity' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\Entities\Shop\Brend A AppBundle\Services\Entities\Shop\Brend instance
     */
    protected function getBrend_EntityService()
    {
        return $this->services['brend.entity'] = new \AppBundle\Services\Entities\Shop\Brend($this);
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('eLOciCLLKK', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lT59gHCQPJ', 0, 'xTk6e8WHxTEtNBHbXJH5cg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cNVwVSVgjH', 0, 'xTk6e8WHxTEtNBHbXJH5cg', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iUYUeSyNKk', 0, 'xTk6e8WHxTEtNBHbXJH5cg', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'wy', 'user' => 'root', 'password' => 'bus82and', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9fafc81719c30fe23104fc69d1bac10688318df84523d2610bcba7322c608baf');
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType' => 'form.type.form', 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType' => 'form.type.choice', 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType' => 'form.type.entity'), array('Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType' => array(0 => 'app.image_type_extension'), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType' => array(0 => 'form.type_extension.form.http_foundation', 1 => 'form.type_extension.form.validator', 2 => 'form.type_extension.upload.validator', 3 => 'form.type_extension.csrf', 4 => 'form.type_extension.form.data_collector'), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\RepeatedType' => array(0 => 'form.type_extension.repeated.validator'), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\SubmitType' => array(0 => 'form.type_extension.submit.validator')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.doctrine'))), $this->get('form.resolved_type_factory'));
    }
    ...
    /**
     * Gets the 'hwi_oauth.resource_owner.mailru' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['hwi_oauth.resource_owner.mailru'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\MailRuResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => 747626, 'client_secret' => 'c52019d7de961fa1f302bfd1d508e40a', 'paths' => array(), 'options' => array()), 'mailru', new \HWI\Bundle\OAuthBundle\OAuth\RequestDataStorage\SessionStorage($this->get('session')));
    }

    /**
     * Gets the 'hwi_oauth.resource_ownermap.oauth_public' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getHwiOauth_ResourceOwnermap_OauthPublicService()
    {
        $this->services['hwi_oauth.resource_ownermap.oauth_public'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array('mailru' => 'mailru'), array('mailru' => '/login_mailru'));
    ...
    protected function getHwiOauth_Security_OauthUtilsService()
    {
        ...
        $instance->addResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.oauth_public'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Provider\Provider A AppBundle\Provider\Provider instance
     */
    protected function getHwiOauth_User_Provider_EntityService()
    {
        return $this->services['hwi_oauth.user.provider.entity'] = new \AppBundle\Provider\Provider($this->get('session'), $this->get('doctrine'), $this->get('admin.checker'), $this->get('request_stack'));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.oauth_public' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance
     */
    protected function getSecurity_Firewall_Map_Context_OauthPublicService()
    {
        ...
        $i->setProviderKey('oauth_public');

        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $e, array(), $b);
        $j->setOptions(array('login_path' => '/', 'failure_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $k = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($a, $g, $this->get('security.authentication.session_strategy'), $e, 'oauth_public', $i, $j, array('use_forward' => false, 'check_path' => '/login_check', 'require_previous_session' => true), $b, $c);
        $k->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.oauth_public'));
        $k->setCheckPaths(array(0 => '/login_mailru'));

        return $this->services['security.firewall.map.context.oauth_public'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.user_db'), 2 => $this->get('security.user.provider.concrete.in_memory'), 3 => $this->get('hwi_oauth.user.provider.entity')), 'oauth_public', $b, $c, $d), 2 => $h, 3 => $k, 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '582753d15cabd1.07571453', $b, $g), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'oauth_public', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($f, $e, '/', false), NULL, NULL, $b, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), 'ThisTokenIsNotSoSecretChangeIt', 'secured_area', array('lifetime' => 604800, 'path' => '^/backend', 'name' => 'REMEMBERME', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);

        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $f, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($f, '/backend'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/backend/security/logout'));
        $k->addHandler($this->get('security.logout.handler.session'));
        $k->addHandler($j);

        $l = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($f, array());
        $l->setOptions(array('login_path' => '/backend/security/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $m->setOptions(array('login_path' => '/backend/security/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $n = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $h, $i, $f, 'secured_area', $l, $m, array('check_path' => '/backend/security/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $c, $d, NULL);
        $n->setRememberMeServices($j);

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $b, 2 => $this->get('security.user.provider.concrete.in_memory'), 3 => $this->get('hwi_oauth.user.provider.entity')), 'secured_area', $c, $d, $e), 2 => $k, 3 => $n, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $j, $h, $c, $d, true, $i), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '582753d15cabd1.07571453', $c, $h), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $e, $f, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $f, '/backend/security/login', false), NULL, NULL, $c, false));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.user_db'), $a, 'secured_area', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'ThisTokenIsNotSoSecretChangeIt', 'secured_area'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('582753d15cabd1.07571453'), 3 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($this->get('hwi_oauth.user.provider.entity'), $this->get('hwi_oauth.resource_ownermap.oauth_public'), $a), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('582753d15cabd1.07571453')), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('oauth_public', '/logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_name' => 'wy',
            'database_user' => 'root',
            'database_password' => 'bus82and',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'mailru_client_id' => 747626,
            'mailru_client_secret' => 'c52019d7de961fa1f302bfd1d508e40a',
            'admins' => array(
                'mailru' => array(
                    0 => '747626',
                ),
            ...
            'hwi_oauth.resource_ownermap.configured.oauth_public' => array(
                'mailru' => '/login_mailru',
            ),
